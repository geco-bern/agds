...
Below we provide an example of using the GET command to download data from the [Regridded Harmonized World Soil Database (v1.2)](<https://daac.ornl.gov/cgi-bin/dsviewer.pl?ds_id=1247>) as hosted on the Oak Ridge National Laboratory computer infrastructure.
