...
-   In the next step, compare remaining predictors to be added as a second variable in the model and calculating the model's $R^2$.
-   Choose as second predictor the one leading to the best $R^2$ and compute the model's AIC. 
