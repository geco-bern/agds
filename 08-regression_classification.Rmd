...
hhdf |>
  ...
  hist(breaks=30)
```
Using this example, we'll cover logistic regression, its implementation in R and metrics for classification.
...
This fitted model results in a linear classification boundary that splits the predictor variables space in two. Where that line falls depends on the choice of threshold, in this case $\tau=0.5$. You can see it plotted below:
