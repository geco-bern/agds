...
If you manage to write a full stepwise regression, interpret your results: Visualise the result of the step-wise regression so that it shows how the chosen metric varies with the number of predictors, preferably showing the name of the additional predictor. What do your results suggest? Do your result match your hypothesis from comparing all bivariate models? How do the model metrics change with adding variables? Can you explain their patterns with your statistical knowledge?
