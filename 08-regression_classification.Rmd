...
To get an intuitive understanding of the different abilities of different metrics, compare the scatterplots in Fig. \@ref(fig:correlationplots) and how different aspects of the model-data agreement are measured by different metrics. Definitions of the metrics displayed and other metrics are given below.
