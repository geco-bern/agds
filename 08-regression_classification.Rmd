...
```{r eval = FALSE, label="grass", echo=FALSE, fig.cap="*Echinochloa crus-galli*, image from [swbiodiversity.org](https://swbiodiversity.org/seinet/taxa/index.php?taxon=2915)", out.width="60%", fig.align='center'}
knitr::include_graphics("figures/grass.png")
```
