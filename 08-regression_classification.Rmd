...
1. An evaluation of all bivariate models (single predictor), implementing just steps 1-3 of the algorithm described in \@ref(variableselection). This should be complemented by visualisation and brief discussion the results.
