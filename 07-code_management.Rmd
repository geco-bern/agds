...
1.  Person 1 - clone the github project of the previous step of Person 2

2.  Person 1 - create a new file in this project

3.  Person 1 - with changes made on github create a **pull request**

4.  Person 2 - review the pull request, provide some comments and accept the pull request integrating new code in the project of Person 2
...
7.  Can you create a merge conflict and resolve the merge conflict?
