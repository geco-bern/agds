...
<!-- -   The elevation data in `siteinfo_fluxnet2015` is a continuous numerical variable. Create one ore more variables that turns elevation into a categorical variable with three levels: < 0, 0-1000, 1001-2000, > 2000. Can you find a elegant way to add that this data is in units of `m`? -->
