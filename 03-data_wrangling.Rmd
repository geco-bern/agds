...
-   Reuse the code in the tutorial to aggregate the `hhdf` dataset to the daily scale and calculate the following metrics for `VPD_F` using provided functions in R: maximum value, minimum value, median, and standard deviation.
