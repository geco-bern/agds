...
3.  In RStudio, create RMarkdown file. Then, write your code into the R chunks of the file to aggregate the data per experiment and calculate the log-response ratio within each experiment, as specified below.
    ...
    -   Important: Structure your RMarkdown so that you first load necessary libraries, then load the data with relative paths and not with hard-coded paths (i.e., access your file via `./data/tidy_data.csv` and not with code that looks like this: `"~/Desktop/Studium/.../tidy_data.csv"` or `"C:/Users/.../tidy_data.csv"`), and then write down your solution.
    
    -   _Tip: If you are new to using RMarkdown, check out this [guide](https://www.dataquest.io/blog/r-markdown-guide-cheatsheet/)._
