...
This chapter introduces typical transformation steps, applied to *tabular data*, and implemented using the R [*tidyverse*](https://www.tidyverse.org/) "dialect" (see below). After stuying it, you will be able to:

- Tidy data
- Perform data transformation, including subsetting, aggregating, combining relational data
- Understand axes of variation in the data and handle them for in transformation steps
