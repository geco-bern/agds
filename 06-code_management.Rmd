...
Once a remote git service has been configured you can push your local git repository to this remote repository, syncing both. You can use both the push buttons in the RStudio panel for this. At the end of a day or a session it is always advised to push your changes to your remote repository to store the changes.
...
You will need to remove the \<\<\<, === and \>\>\> brackets and resolve the conflict before committing the changes.
