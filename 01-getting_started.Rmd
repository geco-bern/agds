...
use_pkgs <- c("KernSmooth", "MASS", "Matrix", "ModelMetrics", "R6",
              ...
              "curl", "data.table", "digest", "dplyr", "e1071",
              ...
              "pillar", "pkgconfig", "plyr", "prettyunits", "prodlim", 
...
-   Connect your GitHub account with Git locally, using SSH keys. 
    -   Alternative from RStudio: Go to **Tools \> Global Options \> Git/SVN** and select **Create SSH Key...**. Create an SSH key with the default options (you can also ignore the passphrase and click on "Create"). This will create a new SSH in your default `~/.ssh` folder. Close the window with the message and click on **View public key**. Copy the public key (all the text). Follow [these instructions](https://docs.github.com/en/authentication/connecting-to-github-with-ssh/adding-a-new-ssh-key-to-your-github-account) to add a new SSH key to your GitHub account. Finally, you can [test your SSH connection](https://docs.github.com/en/authentication/connecting-to-github-with-ssh/testing-your-ssh-connection).
    -   Alternative from Terminal: You should sequentially follow the instructions to [check for existing SSH keys](https://docs.github.com/en/authentication/connecting-to-github-with-ssh/checking-for-existing-ssh-keys), [generate a new SSH key](https://docs.github.com/en/authentication/connecting-to-github-with-ssh/generating-a-new-ssh-key-and-adding-it-to-the-ssh-agent), [add a new SSH key to your GitHub account](https://docs.github.com/en/authentication/connecting-to-github-with-ssh/adding-a-new-ssh-key-to-your-github-account) and finally [test your SSH connection](https://docs.github.com/en/authentication/connecting-to-github-with-ssh/testing-your-ssh-connection). Note that, at the top of these websites, there's an option to choose your OS because the steps vary depending on the type of computer your work with.

Now you should see a **Git** panel in RStudio (next to **Environment**) and also be able to use Git in the **Terminal** panel in RStudio, whenever your R Project is also a repository. As mentioned above, we will start working with these tools in a few weeks and they will be a crucial part of the course.
...
Your performance assessment for Applied Geodata Science will be in the form of a report. You will approach the writing of this report as if you were working on a clean, structured and reproducible data science project. The first task is to set up an R project as a *git* repository, and create an R Markdown file for your report. Follow these steps:
...
- Open RStudio. Create a new R project from a GitHub repository. Paste the repository's url, give it a name (by default the same as the repository) and select in which folder you want to keep it locally (for example the base directory `~`). This will clone all the files from GitHub onto the project directory in your computer.
- With this, you're set up. You should have two R projects: a local project containing solutions to general exercises (for yourself) and the report project + git repository (that you'll share with us at the end of the course).
