...
class(my_variable)  # returns "integer"
```
...
There are many more things you can do with data frames. Since they are central to analyzing data with R, we go into more detail in Tutorial 2 and have dedicated all of [Tutorial 3]{#data_wrangling} to teach you how to work with data frames in a tidy way.
