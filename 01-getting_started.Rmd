...
Alternatively, the function `saveRDS()` allows you save single R objects that can then be read into R with a specific (potentially new) variable name. This is more transparent than using `save()` and `load()` and gives the user more control.
...
- Keep figures produced by your code in a sub-directory `./fig/`
...
Let's install all the required packages for this course and load them.

```{r message=FALSE, warning=FALSE}
use_pkgs <- c("KernSmooth", "MASS", "Matrix", "ModelMetrics", "R6",
              "RColorBrewer", "Rcpp", "SQUAREM", "askpass", "backports",
              "base64enc", "bit", "bit64", "bookdown", "broom", "bslib",
              "cachem", "caret", "class", "cli", "clipr", "clock",
              "codetools", "colorspace", "cowplot", "cpp11", "crayon",
              "curl", "data.table", "digest", "e1071",
              "ellipsis", "evaluate", "fansi", "farver", "fastmap", "forcats",
              "foreach", "fs", "furrr", "future", "future.apply", "generics",
              "ggplot2", "globals", "glue", "gower", "gtable", "hardhat",
              "hexbin", "highr", "hms", "htmltools", "httr", "ipred", "isoband",
              "iterators", "jquerylib", "jsonlite", "knitr", "labeling",
              "lattice", "lava", "lifecycle", "listenv", "lubridate",
              "magrittr", "memoise", "mgcv", "mime", "modelr", "munsell",
              "nlme", "nnet", "numDeriv", "openssl", "pROC", "parallelly",
              "pillar", "pkgconfig", "plyr", "dplyr", "prettyunits", "prodlim", 
              "progress", "progressr", "proxy", "purrr", "rappdirs", "readr",
              "recipes", "renv", "reshape2", "rlang", "rmarkdown", "rpart",
              "rpart.plot", "rsample", "sass", "scales", "scico", "sessioninfo",
              "slider", "stringi", "stringr", "survival", "sys", "terra",
              "tibble", "tidyr", "tidyselect", "timeDate", "timechange",
              "tinytex", "tzdb", "utf8", "vctrs", "viridisLite", "visdat",
              "vroom", "warp", "withr", "xfun", "yaml", "yardstick",
              "tidyverse", "MODISTools", "skimr", "hwsdr", "usethis", "ranger")
...
-   If you don't have one already, create a GitHub account on <https://github.com> and sign in. We encourage you to use a personal email so you can keep using this account for years to come, thus compiling your "code knowledge base".
