...
-   Chapters \@ref(getting_started) to Chapter \@ref(randomforest)
...
Chapters \@ref{regressionclassification}-\@ref(randomforest) lead into the world of machine learning and introduce the essential steps of the modelling workflow (from data splitting, to pre-processing, training, and evaluating), without delving into deep learning. Together with its preceeding chapters, this completes the toolbox required for making the first data scientific steps for applications in Geography and Environmental Sciences. This may be only just the beginning...
