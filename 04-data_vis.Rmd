...
- construct plots in a intuitive way
- represent the same data in a variety of ways
...
-   Again, start with the cleaned the half-hourly dataset for site CH-Lae.
...
-   Make this figure ready for publication: 
    ...
    -   Anything else you want to change? Axes limits, axes ticks, grid lines?

> Hint: The functions to make a suitable plot was introduced in the tutorial.
