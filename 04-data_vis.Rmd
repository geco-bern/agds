...
Exercise: using data frame with combined data from multiple sites, visualise the mean seasonal cycle of GPP for each site.
...
Exercise: remove data based on f_measured. Visualise data removal, fill missing data with mean seasonal cycle, visualise good data, bad removed data, and filled data in one plot using different colors
