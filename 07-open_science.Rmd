...
What are the basic steps to create a reproducible workflow from a file management perspective? Create your own "mock" project using these principles. Provide details the on steps involved and why they matter.
