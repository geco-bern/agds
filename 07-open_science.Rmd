...
-   manually clean a data project

    -   provide a dirty project and ask students to tidy it

        -   All scripts data in the top level

        -   no indices indicating execution order

        -   random spurious copies of the data included

    -   let students describe their experience
