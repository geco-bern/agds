...
What are the basic steps to create a reproducible workflow from a file management perspective?

Create your own project using these principles and provide details the on steps involved and why they matter.
...
-   Install an additional library and update the state of your project
